---
name: "[회의 PACAA-737] vendor 모델 분류 표현 — Legal 표시광고법/통신판매업법 분류 표시 자문"
assignee: "ceo"
---

**Legal Counsel 자문 청구** — vendor 모델 분류 표시 법적 함의 (PACAA-737 회의, SG-2 표시광고법 + SG-3 통신판매업).
...
---
## Legal 검토 질문 (표시광고법 / 통신판매업법)

1. **평가성 라벨**: "기업 거래 전문" / "샘플·소량부터 가능" 라벨이 표시광고법 §3 평가성 라벨에 해당하는가? (memory `feedback_vendor_telesales_registration_signal.md` 광고법 §3 회피 원칙 baked)
2. **분류 신호로의 통신판매업 신고**: 통신판매업 신고 여부를 분류 신호로 사용하는 것이
